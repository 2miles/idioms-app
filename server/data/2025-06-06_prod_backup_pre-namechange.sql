...
CREATE TABLE public.idioms_examples_test (
    example_id integer DEFAULT nextval('public.idioms_examples_test_example_id_seq'::regclass) NOT NULL,
...
1066	Pissing into the wind	\N	To do something totally pointless, fruitless, or futile; to waste onen’s time doing something that will not or cannot come to pass.	Miles	2023-11-16 07:00:03+00
...
1122	If frogs had wings they wouldnn’t bump their asses when they hopped	\N	Used to advise someone not to wish for something impossible.	Miles	2025-07-04 18:07:20+00
...
1061	As the twig is bent so grows the tree	\N	The shaping of a personn’s character, values, and behaviors begins from a young age and continues to influence them throughout their life	Miles	2023-11-07 07:00:02+00
...
SELECT pg_catalog.setval('public.idioms_examples_test_example_id_seq', 4969, true);
...
SELECT pg_catalog.setval('public.idioms_test_id_seq', 1122, true);
...
ALTER TABLE ONLY public.idioms_examples_test
    ADD CONSTRAINT idioms_examples_test_idiom_id_fkey FOREIGN KEY (idiom_id) REFERENCES public.idioms_test(id) ON DELETE CASCADE;
...
--
-- Name: SEQUENCE idioms_examples_test_example_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.idioms_examples_test_example_id_seq TO anon;
GRANT ALL ON SEQUENCE public.idioms_examples_test_example_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.idioms_examples_test_example_id_seq TO service_role;


--
-- Name: TABLE idioms_examples_test; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.idioms_examples_test TO anon;
GRANT ALL ON TABLE public.idioms_examples_test TO authenticated;
GRANT ALL ON TABLE public.idioms_examples_test TO service_role;


--
-- Name: TABLE idioms_origin_test; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.idioms_origin_test TO anon;
GRANT ALL ON TABLE public.idioms_origin_test TO authenticated;
GRANT ALL ON TABLE public.idioms_origin_test TO service_role;


--
-- Name: SEQUENCE idioms_origin_test_origin_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.idioms_origin_test_origin_id_seq TO anon;
GRANT ALL ON SEQUENCE public.idioms_origin_test_origin_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.idioms_origin_test_origin_id_seq TO service_role;


--
-- Name: SEQUENCE idioms_test_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.idioms_test_id_seq TO anon;
GRANT ALL ON SEQUENCE public.idioms_test_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.idioms_test_id_seq TO service_role;


--
-- Name: TABLE idioms_test; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.idioms_test TO anon;
GRANT ALL ON TABLE public.idioms_test TO authenticated;
GRANT ALL ON TABLE public.idioms_test TO service_role;
